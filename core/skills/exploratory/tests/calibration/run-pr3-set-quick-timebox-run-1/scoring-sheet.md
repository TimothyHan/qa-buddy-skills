# Scoring sheet — exploratory · run-pr3-set-quick-timebox-run-1

Source: eval-run · case quick-timebox · from .qa-reports/evals/exploratory/pr3-set/quick-timebox/run-1/workspace
