...
function callerWorkflow(o) {
  const ref = o.qabuddyRef || 'v0.9.0-poc.2';
...
function cmdInit(o) {
  ...
  process.stdout.write(JSON.stringify({ schema: 'pr-init/1', workflow: path.relative(root, wf), reusable: REUSABLE_WORKFLOW, ref: o.qabuddyRef || 'v0.9.0-poc.2', labels, next }, null, 2) + '\n');
}
