...
5. **앱 감지** -- 지정된 URL 또는 일반 포트(3000, 4000, 5173, 8080)에서 앱을 찾습니다. `.qa-reports/screenshots/`를 생성합니다.
...
- [ ] 모든 발견 사항에 구체적인 단계, 기대/실제 구분, 스크린샷, 조치가 있음
- [ ] 문제 수정: 재분류, 중복 제거, 누락된 스크린샷 촬영. 한 번만 통과.
