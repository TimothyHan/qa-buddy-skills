...
- 없는 경우: "{BUG-KEY}에 대한 회귀 테스트가 없습니다. `/test-cases {TICKET-KEY} --update`로 추가하는 것을 권장합니다."
...
- **REGRESSION:** 원본은 Verified로 유지하고, `/qa` 버그 등록 워크플로우를 통해 새 버그를 등록합니다.
