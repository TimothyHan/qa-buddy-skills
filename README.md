...
[![Structural checks: 1844](https://img.shields.io/badge/Structural_checks-1844-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1844 structural checks
```
...
├── test.js                      # Structural check suite (1844 checks)
