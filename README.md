...
[![Structural checks: 1428](https://img.shields.io/badge/Structural_checks-1428-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1428 structural checks
```
...
├── test.js                      # Structural check suite (1428 checks)
