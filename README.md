...
[![Structural checks: 1353](https://img.shields.io/badge/Structural_checks-1353-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1353 structural checks
```
...
├── test.js                      # Structural check suite (1353 checks)
