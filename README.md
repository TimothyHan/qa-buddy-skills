...
[![Structural checks: 1526](https://img.shields.io/badge/Structural_checks-1526-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1526 structural checks
```
...
├── test.js                      # Structural check suite (1526 checks)
