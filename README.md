...
[![Structural checks: 1418](https://img.shields.io/badge/Structural_checks-1418-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1418 structural checks
```
...
├── test.js                      # Structural check suite (1418 checks)
