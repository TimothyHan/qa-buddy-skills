...
[![Structural checks: 1405](https://img.shields.io/badge/Structural_checks-1405-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1405 structural checks
```
...
├── test.js                      # Structural check suite (1405 checks)
