...
[![Structural checks: 1715](https://img.shields.io/badge/Structural_checks-1715-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1715 structural checks
```
...
├── test.js                      # Structural check suite (1715 checks)
