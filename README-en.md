...
[![Structural checks: 1105](https://img.shields.io/badge/Structural_checks-1105-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1105 structural checks
```
...
├── test.js                      # Structural check suite (1105 checks)
