...
[![Structural checks: 1148](https://img.shields.io/badge/Structural_checks-1148-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1148 structural checks
```
...
├── test.js                      # Structural check suite (1148 checks)
