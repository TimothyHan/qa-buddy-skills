...
[![Structural checks: 1151](https://img.shields.io/badge/Structural_checks-1151-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1151 structural checks
```
...
├── test.js                      # Structural check suite (1151 checks)
