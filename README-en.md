...
[![Structural checks: 1147](https://img.shields.io/badge/Structural_checks-1147-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1147 structural checks
```
...
├── test.js                      # Structural check suite (1147 checks)
