...
[![Structural checks: 1201](https://img.shields.io/badge/Structural_checks-1201-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1201 structural checks
```
...
├── test.js                      # Structural check suite (1201 checks)
