...
[![Structural checks: 1160](https://img.shields.io/badge/Structural_checks-1160-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1160 structural checks
```
...
├── test.js                      # Structural check suite (1160 checks)
