...
[![Structural checks: 1215](https://img.shields.io/badge/Structural_checks-1215-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1215 structural checks
```
...
├── test.js                      # Structural check suite (1215 checks)
