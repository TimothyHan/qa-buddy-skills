...
[![Structural checks: 1150](https://img.shields.io/badge/Structural_checks-1150-brightgreen.svg)](#how-it-works)
...
node test.js                       # Run 1150 structural checks
```
...
├── test.js                      # Structural check suite (1150 checks)
